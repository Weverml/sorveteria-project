...
public class SorveteTradicional extends Sorvete {
    private boolean temAdicionais = false;
    
    public SorveteTradicional() {
		
	}
    public SorveteTradicional(int recipiente, double preco, String sabor[], Cardapio opcoes, int quantBolas,  String calda, Adicionais adicional ) {
